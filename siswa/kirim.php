...
<body>
    ...
    <div class="card my-4">
      <h1 style="margin-left: 20px;"><i class="fas fa-money-check-alt"></i> Transfer</h1>
         <p style="margin-left: 70px; font-size: 20px; font-style: italic;">Transfer dengan mudah dengan DEKSI</p> 
    </div>
    <h1>
        NISN <small class="text-muted"><?=$data["nisn"]?></small>
    </h1>
