...
<div class="card my-4">
    <h1 style="margin-left: 20px;"><i class="fa fa-book fa-history"></i> Transaksi<button class="btn btn-primary" onclick="printHistory()"><i class="fa fa-print" aria-hidden="true"></i></button></h1>
