...
<body>
    ...
    <a class="no-print btn btn-primary ml-5 mt-5" href="../kantin/info_kantin.php?id=<?= $_GET["idkantin"] ?>">kembali</a>
    ...
    <a class="no-print btn btn-primary ml-5" href="../kantin/info_kantin.php?id=<?= $_GET["idkantin"] ?>">kembali</a>
