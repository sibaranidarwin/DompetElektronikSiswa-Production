    ...
    <div class="row">
                            ...
                            <table class="table">
                                ...
                                foreach ($qr as $q) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $q->nilai ?></td>
                                        <td><a href="<?= "../actions/printqr2.php?qrdata=$q->unique_id&judul=$q->judul&kantin=$kantin->nama&idkantin=$kantin->id" ?>">Print</a></td>
                                    </tr>
                            ...
                            <table class="table">
                                ...
                                foreach ($transaksi as $d) {
                                    ...
                                    <tr>
                                        <td><?= $d->id ?></td>
                                        <td><?= $d->qr_id ?></td>
                                        <td><a href="detail_siswa.php?id=<?= $d->siswa_id ?>"><?= $d->siswa_id ?></a></td>
                                        <td><?= $d->tanggal ?></td>
        ...
        <div class="col-md-7">
            ...
            <div class="card p-4 mt-3" id="buat_qr">
                <form action="../actions/qr_baru2.php" method="post">
                    <h3>Buat Kode QR</h3>
            ...
            <div class="card p-4 my-3" id="tarik_tunai">
                ...
                <form action="../actions/tarik_tunai_kantin.php" method="post">
                    ...
                    <div class="form-group">
                        <label for="password">Password kantin</label>
