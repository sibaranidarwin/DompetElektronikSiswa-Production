        ...
        <div class="card-body">
            <form action="../actions/ubah_password.php" method="post" class="validatedForm">
                <div class="form-group">
                    ...
                    <input type="password" name="old_password" id="lama_password" class="form-control mb-1">
                </div>

                <div class="form-group">
                    <label for="new_password">Password baru</label>
                    <input type="password" name="new_password" id="baru_password" class="form-control mb-1">
                </div>

                <div class="form-group">
                    <label for="baru_password_confirm">Konfirmasi password baru</label>
                    <input type="password" name="baru_password_confirm" id="baru_password_confirm" class="form-control mb-1">
                </div>
