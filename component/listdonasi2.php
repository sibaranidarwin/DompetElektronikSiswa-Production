...
$istatausaha = isset($_SESSION['tata_usahaid']);
...
if ($res) {
    ...
    foreach ($res as $r) {
        ...
        $percentage = number_format(($r->terkumpul) * 100, 2, '.', '');
                ...
                <div class='card-body'>
                    ...
                    <div class="table-responsive mb-1">
                        <table class='table'>
                            <tr>
                                <th>Terkumpul</th><!-- 
                                <th class="text-right">Harapan Donasi</th> -->
                            </tr>
                            <tr>
                    ...
                    <?php if ($r->status == "open") { ?>
                        ...
                        <a href='<?= $istatausaha? "infodonasi" : "bayardonasi" ?>.php?id_donasi=<?= $r->id ?>' class='btn btn-primary m-1'>Pelajari Lebih Lanjut!</a>

                        <?php if ($istatausaha) { ?>
                            <form action="../actions/status_donasi2.php" method="POST" class="d-inline">
                                <input type="hidden" name="id" value="<?= $r->id ?>">
